...
void ConnectionRequestMessage::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<string>(6, "resume_session_id", resume_session_id);
}
...
unique_ptr<ConnectionRequestMessage> ConnectionRequestMessage::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<string>(6, "resume_session_id", result->resume_session_id);
	return result;
}
